...
const reviewsData: Review[] = [
  {
    id: 1,
    text: "Я прийшла з відчуттям постійної втоми і внутрішнього вигорання 😔 З кожною зустріччю з'являлось більше легкості — ніби стає трохи більше повітря 🌬️ Навіть складні речі ми проговорювали дуже м'яко, без болю. Це було схоже на розмову з подругою за кавою ☕ після якої стає тепліше всередині.",
  },
  {
    id: 2,
